<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3 menu-logo">
            <img src="include/asset/images/logo.png">
        </div>
        <div class="col-sm-1"></div>
        <div class="col-sm-8 listitemmenu">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="main_nav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link dathenkham" href="#">
                            <img src="include/asset/images/dathenkham.png">
                        </a></li>
