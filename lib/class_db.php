...
class db {
	...
	function pagesList1($baseURL, $totalRows , $pageNum=1, $pageSize = 5, $offset = 5){
		...
		if ($pageNum > 1) {
			$firstLink = "<a class='phantrang_hinh' title='Trang đầu' href='$baseURL/'>&#171;</a>";
			$prevPage = $pageNum - 1;
			$prevLink="<a class='phantrang_hinh' title='Trang trước' href='$baseURL/page-$prevPage.html'>&lsaquo;</a>";
		}
		...
		if ($pageNum < $totalPages) {
			$lastLink = "<a class='phantrang_hinh' title='Trang cuối' href='$baseURL/page-$totalPages.html'>&#187;</a>";
			$nextPage = $pageNum + 1;
			$nextLink = "<a class='phantrang_hinh' title='Trang sau' href='$baseURL/page-$nextPage.html'>&rsaquo;</a>";
		}
		return $firstLink.$prevLink.$links.$nextLink.$lastLink;
	} // function pagesList1
