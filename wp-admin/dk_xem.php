<?php
  ...
  if($_SESSION['tg_login_level'] !=0) header("location:main.php");
...
<script type="text/javascript">
  $(document).ready(function() {
	...
	$(".ngay_picker").datepicker({dateFormat: 'dd-mm-yy'});
  });
  function nhapchuot(){
    var dulieu = $("#sdt").val();
...
<form action="excel/sodienthoai.php" method="post">
	Từ ngày <input type="text" class="ngay_picker" placeholder="Từ ngày..." style="width:150px" name="tungay" />&nbsp;
	Đến ngày <input type="text" class="ngay_picker" placeholder="Đến ngày..." style="width:150px" name="denngay" />&nbsp;
	<input type="submit" value="Xuất" />
</form>
<p>
<a href="http://phongkhamdaitin.vn/wp-admin/main.php?p=dk_xem"><input type="button" style="width:200px" value="Cập Nhật" /></a>
<a href="http://phongkhamdaitin.vn/wp-admin/main.php?p=dk_xem&khongcapnhat=1"><input type="button" style="width:200px" value="Dừng Cập Nhật" /></a>
</p>
<br/>
...
<tr>
    <th width="50">Mã</th>
    <th width="100">Ngày Giờ DK</th>
    <!--<th width="100">Tên</th>-->
    <th>Triệu chứng</th>
    <th width="100">Điện Thoại</th>
	<th width="200">Link web người dùng xem</th>
    <th width="130">IP người dùng</th>
...
$str = str_replace("{NgayGioDK}",date("H:i:s --- d/m/Y",strtotime($row_loaisp['NgayGioDK'])),$str);
//$str = str_replace("{hoten}",$row_loaisp['hoten'],$str);
$str = str_replace("{trieuchung}",$row_loaisp['trieuchung'],$str);
