...
<tr><td width="100">link chuyển</td>
     <td><input type="text" name="linkchuyen" id="linkchuyen" value="<?php echo $row_sanpham['linkchuyen'] ?>" /></td>
</tr>
<tr><td width="100">cờ</td>
     <td><input type="text" name="co" id="co" value="<?php echo $row_sanpham['co'] ?>" /></td>
</tr>
