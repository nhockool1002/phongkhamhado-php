...
<script>
    ...
    function hienthumb(){
      ...
      if (valu != "") {
        var bien = "<img src='"+valu+"' height='150'>";
        $('#thumbnail').html(bien);
      };
    }
...
<!--<tr><td width="100">Chuyển hướng</td>
     <td><input name="ReDirect" type="text" id="ReDirect" value="<?php echo $row_sanpham['ReDirect'] ?>" /></td>
</tr>-->
<tr><td>Hình Ảnh</td>
     <td>
...
var editor = CKEDITOR.replace( 'TomTat',{
  ...
  filebrowserFlashUploadUrl : 'ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash',
	height: '150px',
  toolbar:[
  { name: 'basicstyles', items : [ 'Bold','Italic','Underline' , 'Image', 'Format'] },{ name: 'links', items : [ 'Link','Unlink','Anchor' ] }
  ]
});
</script>
     </td>
